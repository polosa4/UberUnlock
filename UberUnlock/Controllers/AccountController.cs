    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(string email, string username)
        {
            ...
            if (user != null)
            {
                ...
                string resetLink = Request.Url.GetLeftPart(UriPartial.Authority) + "/Account/ResetPassword/" + user.Id + "?token=" + HttpUtility.UrlEncode(resetToken);

                string htmlContent = string.Format("<a href=\"{0}\">Reset Your Password</a>", resetLink);
                await UserManager.SendEmailAsync(user.Id, "Reset your Coding Cookware Password", htmlContent);
            }
